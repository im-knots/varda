/*{
    ...
    "INPUTS": [
        ...
        {"NAME": "rotation_speed", "TYPE": "float", "GROUP": "Camera", "DEFAULT": 1.0,  "MIN": 0.0, "MAX": 3.0,   "LABEL": "Rotation Speed"},
        {"NAME": "kaleidoscope",   "TYPE": "float", "DEFAULT": 12.0, "MIN": 2.0, "MAX": 40.0,  "LABEL": "Kaleidoscope Folds"},
        {"NAME": "truchet_radius", "TYPE": "float", "GROUP": "Form", "DEFAULT": 0.38, "MIN": 0.1, "MAX": 0.49,  "LABEL": "Truchet Radius"},
        {"NAME": "line_width",     "TYPE": "float", "DEFAULT": 1.0,  "MIN": 0.2, "MAX": 3.0,   "LABEL": "Line Width"},
        {"NAME": "plane_count",    "TYPE": "float", "GROUP": "Form", "DEFAULT": 6.0,  "MIN": 1.0, "MAX": 10.0,  "LABEL": "Plane Depth"},
        {"NAME": "plane_gap",      "TYPE": "float", "GROUP": "Form", "DEFAULT": 0.75, "MIN": 0.2, "MAX": 2.0,   "LABEL": "Plane Spacing"},
        {"NAME": "zoom",           "TYPE": "float", "GROUP": "Camera", "DEFAULT": 1.0,  "MIN": 0.3, "MAX": 3.0,   "LABEL": "Zoom"},
        {"NAME": "path_amplitude", "TYPE": "float", "GROUP": "Camera", "DEFAULT": 1.0,  "MIN": 0.0, "MAX": 3.0,   "LABEL": "Path Wobble"},
        {"NAME": "smooth_edge",    "TYPE": "float", "GROUP": "Form", "DEFAULT": 0.5,  "MIN": 0.0, "MAX": 1.0,   "LABEL": "Edge Smoothness"},
        {"NAME": "color_mode",     "TYPE": "float", "GROUP": "Palette", "DEFAULT": 0.0,  "MIN": 0.0, "MAX": 5.0,   "LABEL": "Color Mode (0=BW 1=Custom 2=Rainbow 3=Neon 4=Warm 5=Cool)"},
        {"NAME": "color_a",        "TYPE": "color", "GROUP": "Palette", "DEFAULT": [1.0, 0.2, 0.4, 1.0], "LABEL": "Color A"},
        {"NAME": "color_b",        "TYPE": "color", "GROUP": "Palette", "DEFAULT": [0.2, 0.5, 1.0, 1.0], "LABEL": "Color B"},
        {"NAME": "saturation",     "TYPE": "float", "GROUP": "Grade", "DEFAULT": 1.0,  "MIN": 0.0, "MAX": 2.0,   "LABEL": "Saturation"},
        {"NAME": "brightness",     "TYPE": "float", "GROUP": "Grade", "DEFAULT": 1.0,  "MIN": 0.2, "MAX": 3.0,   "LABEL": "Brightness"},
        {"NAME": "vignette_amount","TYPE": "float", "GROUP": "Grade", "DEFAULT": 1.0,  "MIN": 0.0, "MAX": 2.0,   "LABEL": "Vignette"}
    ],
    "PHASE_INPUTS": [
