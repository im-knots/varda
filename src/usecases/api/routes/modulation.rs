...
pub async fn add_lfo(
    ...
    match state.send_command(EngineCommand::AddLfo {
...
pub async fn add_audio_band(
    ...
    match state.send_command(EngineCommand::AddAudioBand {
        preset: body.preset,
...
pub async fn add_adsr(
    ...
    match state.send_command(EngineCommand::AddAdsr {
        attack: body.attack,
        decay: body.decay,
...
pub async fn add_step_sequencer(
    ...
    match state.send_command(EngineCommand::AddStepSequencer {
...
pub async fn remove_source(
    ...
    match state.send_command(EngineCommand::RemoveModulationSource { uuid }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn assign(
    ...
    match state.send_command(EngineCommand::AssignModulation {
        target: body.target,
        source_id: body.source_id,
        amount: body.amount,
    }).await {
...
pub async fn clear(
    ...
    match state.send_command(EngineCommand::ClearModulation { target: body.target }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn update_lfo_frequency(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateLfoFrequency { uuid, frequency: b.value }).await {
...
pub async fn update_lfo_waveform(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<WaveformBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateLfoWaveform { uuid, waveform: b.waveform }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_lfo_phase(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateLfoPhase { uuid, phase: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_lfo_amplitude(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateLfoAmplitude { uuid, amplitude: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_lfo_bipolar(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<BoolBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateLfoBipolar { uuid, bipolar: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_smoothing(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioSmoothing { uuid, smoothing: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_freq_range(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FreqRangeBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioFreqRange { uuid, freq_low: b.freq_low, freq_high: b.freq_high }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_gain(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioGain { uuid, gain: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_preset(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<PresetBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioPreset { uuid, preset: b.preset }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_mode(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<AudioModeBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioMode { uuid, mode: b.mode }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_adsr_attack(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAdsrAttack { uuid, attack: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_adsr_decay(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAdsrDecay { uuid, decay: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_adsr_sustain(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAdsrSustain { uuid, sustain: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_adsr_release(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAdsrRelease { uuid, release: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn trigger_adsr(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
...
pub async fn release_adsr(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
...
pub async fn update_step_seq_steps(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<StepsBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateStepSeqSteps { uuid, steps: b.steps }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_step_seq_rate(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateStepSeqRate { uuid, rate: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_step_seq_interpolation(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<InterpolationBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateStepSeqInterpolation { uuid, interpolation: b.interpolation }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_source(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<ModAudioSourceBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioSource { uuid, source_id: b.source_id }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_audio_noise_gate(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<FloatBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateAudioNoiseGate { uuid, noise_gate: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_step_seq_bipolar(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<BoolBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateStepSeqBipolar { uuid, bipolar: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_seq_count(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<StepSeqCountBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepSeqCount { uuid, count: b.count }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn update_step_seq_value(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<StepSeqValueBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateStepSeqValue { uuid, step_idx: b.step_idx, value: b.value }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn assign_mod_on_mod(State(s): State<SharedState>, Json(b): Json<AssignModOnModBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AssignModOnMod { target_source_id: b.target_source_id, param_name: b.param_name, modulator_id: b.modulator_id, amount: b.amount }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn remove_mod_on_mod(State(s): State<SharedState>, Json(b): Json<RemoveModOnModBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::RemoveModOnMod { target_source_id: b.target_source_id, param_name: b.param_name }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
