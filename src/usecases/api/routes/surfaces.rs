...
pub async fn add_rect(State(s): State<SharedState>, Json(b): Json<AddRectSurfaceBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AddSurface { name: b.name, source: b.source }).await {
...
pub async fn add_circle(State(s): State<SharedState>, Json(b): Json<AddCircleSurfaceBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AddCircleSurface {
        name: b.name, center: b.center, radius: b.radius, sides: b.sides, aspect_ratio: b.aspect_ratio, source: b.source,
    }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
...
pub async fn set_source(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<SetSourceBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetSurfaceSource { uuid, source: b.source }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn set_output_type(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<SetOutputTypeBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetSurfaceOutputType { uuid, output_type: b.output_type }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn set_content_mapping(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<SetContentMappingBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetSurfaceContentMapping { uuid, mapping: b.mapping }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn rename(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<RenameBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::RenameSurface { uuid, name: b.name }).await {
        Ok(r) => command_response(r),
        Err(msg) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, msg).into_response(),
    }
}
...
pub async fn set_vertices(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<VerticesBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::UpdateSurfaceVertices { uuid, vertices: b.vertices }).await {
...
pub async fn duplicate(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
    match s.send_command(EngineCommand::DuplicateSurface { uuid }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn flip_horizontal(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
    match s.send_command(EngineCommand::FlipSurfaceHorizontal { uuid }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn flip_vertical(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
    match s.send_command(EngineCommand::FlipSurfaceVertical { uuid }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn insert_vertex(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<InsertVertexBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::InsertSurfaceVertex { uuid, after_vert_idx: b.after_vert_idx, position: b.position }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_circle_radius(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<RadiusBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetCircleRadius { uuid, radius: b.radius }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_circle_sides(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<SidesBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetCircleSides { uuid, sides: b.sides }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn convert_to_polygon(State(s): State<SharedState>, Path(uuid): Path<String>) -> impl IntoResponse {
    match s.send_command(EngineCommand::ConvertSurfaceToPolygon { uuid }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn move_surface(State(s): State<SharedState>, Path(uuid): Path<String>, Json(b): Json<MoveBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::MoveSurface { uuid, dx: b.dx, dy: b.dy }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
