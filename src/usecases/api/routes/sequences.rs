...
pub async fn add_fade_step(State(s): State<SharedState>, Path(idx): Path<usize>, Json(b): Json<AddFadeStepBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AddFadeStep { seq_idx: idx, from_ch: b.from_ch, to_ch: b.to_ch }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn add_wait_step(State(s): State<SharedState>, Path(idx): Path<usize>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AddWaitStep { seq_idx: idx }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn add_goto_step(State(s): State<SharedState>, Path(idx): Path<usize>, Json(b): Json<AddGoToStepBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::AddGoToStep { seq_idx: idx, step_index: b.step_index }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn remove_step(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>) -> impl IntoResponse {
    match s.send_command(EngineCommand::RemoveStep { seq_idx, step_idx }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_duration(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<StepDurationBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepDuration { seq_idx, step_idx, value: b.value, unit: b.unit }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_easing(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<StepEasingBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepEasing { seq_idx, step_idx, easing: b.easing }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_shader(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<StepShaderBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepTransitionShader { seq_idx, step_idx, shader_name: b.shader_name }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_from_ch(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<StepChBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepFromCh { seq_idx, step_idx, ch: b.ch }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_step_to_ch(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<StepChBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetStepToCh { seq_idx, step_idx, ch: b.ch }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn set_goto_target(State(s): State<SharedState>, Path((seq_idx, step_idx)): Path<(usize, usize)>, Json(b): Json<GoToTargetBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::SetGoToTarget { seq_idx, step_idx, target: b.target }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
...
pub async fn move_step(State(s): State<SharedState>, Path(idx): Path<usize>, Json(b): Json<MoveStepBody>) -> impl IntoResponse {
    match s.send_command(EngineCommand::MoveStep { seq_idx: idx, from: b.from, to: b.to }).await {
        Ok(r) => command_response(r), Err(m) => (axum::http::StatusCode::INTERNAL_SERVER_ERROR, m).into_response(),
    }
}
