...
pub(super) fn render_modulation_section(ui: &mut egui::Ui, data: &UIData, actions: &mut UIActions) {
    ui.horizontal(|ui| {
        if ui.button("➕ LFO").clicked() {
            actions.commands.push(EngineCommand::AddLfo {
                waveform: LFOWaveform::Sine,
                frequency: 1.0,
            });
        }
        if ui.button("➕ Audio").clicked() {
            actions.commands.push(EngineCommand::AddAudioBand {
                preset: crate::modulation::AudioBandPreset::Low,
                source_id: None,
            });
        }
        if ui.button("➕ ADSR").clicked() {
            actions.commands.push(EngineCommand::AddAdsr {
                attack: 0.1,
                decay: 0.3,
                sustain: 0.7,
                release: 0.5,
        ...
        if ui.button("➕ StepSeq").clicked() {
            actions.commands.push(EngineCommand::AddStepSequencer {
                num_steps: 8,
                rate: 2.0,
            });
        }
                        ...
                        .show(ui, |ui| {
                            ...
                            match &entry.source {
                                ModSourceUI::LFO {
                                                ...
                                                for (i, name) in waveforms.iter().enumerate() {
                                                        ...
                                                        .changed()
                                                    {
                                                        ...
                                                        actions.commands.push(
                                                            EngineCommand::UpdateLfoWaveform {
                                                                uuid: sid.clone(),
                                                                waveform: new_wf,
                                                            },
                                                        );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            &mut freq,
                                            0.01..=10.0,
                                            |s| s.logarithmic(true).show_value(true).suffix("Hz"),
                                            &path,
                                            data,
                                            actions,
                                        ) {
                                            actions.commands.push(
                                                EngineCommand::UpdateLfoFrequency {
                                                    uuid: sid.clone(),
                                                    frequency: freq,
                                                },
                                            );
                                        }
                                        render_mod_on_mod_dropdown(
                                            ui,
                                            data,
                                            actions,
                                            sid,
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            actions.commands.push(
                                                EngineCommand::UpdateLfoAmplitude {
                                                    uuid: sid.clone(),
                                                    amplitude: amp,
                                                },
                                            );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            &mut ph,
                                            0.0..=1.0,
                                            |s| s.show_value(false),
                                            &path,
                                            data,
                                            actions,
                                        ) {
                                            actions.commands.push(EngineCommand::UpdateLfoPhase {
                                                uuid: sid.clone(),
                                                phase: ph,
                                            });
                                        }
                                    ...
                                    if ui
                                        .checkbox(
                                            &mut bp,
                                            egui::RichText::new("Bipolar (-1 to 1)").small(),
                                        )
                                        .changed()
                                    {
                                        actions.commands.push(EngineCommand::UpdateLfoBipolar {
                                            uuid: sid.clone(),
                                            bipolar: bp,
                                        });
                                    }
                                ...
                                ModSourceUI::Audio {
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        egui::ComboBox::from_id_salt(format!("audio_mode_{}", idx))
                                            ...
                                            .show_ui(ui, |ui| {
                                                for (name, m) in [
                                                    ("Direct", AudioReactMode::Direct),
                                                    ("Increase", AudioReactMode::Increase),
                                                    ("Decrease", AudioReactMode::Decrease),
                                                ] {
                                                    if ui
                                    ...
                                    {
                                        "Low"
                                    } else if (*freq_low - 250.0).abs() < 1.0
                                        && (*freq_high - 2000.0).abs() < 1.0
                                    {
                                        "Mid"
                                    } else if (*freq_low - 2000.0).abs() < 1.0
                                        && (*freq_high - 20000.0).abs() < 1.0
                                    {
                                        "High"
                                    } else if (*freq_low - 20.0).abs() < 1.0
                                        && (*freq_high - 20000.0).abs() < 1.0
                                    {
                                        "Full"
                                    } else {
                                        ...
                                        .show_ui(
                                            ...
                                            |ui| {
                                                ...
                                                for (name, preset) in [
                                                    ...
                                                    ("Mid", AudioBandPreset::Mid),
                                                    ("High", AudioBandPreset::High),
                                                    ("Full", AudioBandPreset::Full),
                                                ] {
                                                    if ui
                                                        .selectable_label(
                                                            preset_label == name,
                                                    ...
                                                    {
                                                        actions.commands.push(
                                                            EngineCommand::UpdateAudioPreset {
                                                                uuid: sid.clone(),
                                                                preset,
                                                            },
                                                        );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            &mut fl,
                                            20.0..=20000.0,
                                            |s| s.logarithmic(true).suffix("Hz"),
                                            &path,
                                            data,
                                            actions,
                                        ) {
                                            actions.commands.push(
                                                EngineCommand::UpdateAudioFreqLow {
                                                    uuid: sid.clone(),
                                                    freq_low: fl,
                                                },
                                            );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            actions.commands.push(
                                                EngineCommand::UpdateAudioFreqHigh {
                                                    uuid: sid.clone(),
                                                    freq_high: fh,
                                                },
                                            );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if render_mod_learn_slider(
                                            ...
                                            actions.commands.push(
                                                EngineCommand::UpdateAudioSmoothing {
                                                    uuid: sid.clone(),
                                                    smoothing: sm,
                                                },
                                            );
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if ui
                                            .add(
                                                egui::Slider::new(&mut ng, 0.0..=0.5)
                                                    .show_value(true),
                                            )
                                            .changed()
                                        {
                                            actions.commands.push(
                                                EngineCommand::UpdateAudioNoiseGate {
                                                    uuid: sid.clone(),
                                                    noise_gate: ng,
                                                },
                                            );
                                        ...
                                        ui.horizontal(|ui| {
                                            ...
                                            .show_ui(
                                                ...
                                                |ui| {
                                                    ...
                                                    {
                                                        actions.commands.push(
                                                            EngineCommand::UpdateAudioSource {
                                                                uuid: sid.clone(),
                                                                source_id: None,
                                                            },
                                                        );
                                ...
                                ModSourceUI::ADSR {
                                    ...
                                    let was_held = ui.memory(|m| {
                                        m.data.get_temp::<bool>(gate_id).unwrap_or(false)
                                    });
                                    let label = if was_held {
                                        "⏹ Gate (held)"
                                    } else {
                                        "▶ Gate"
                                    };
                                    let btn_color = if was_held {
                                    ...
                                    if !any_learn {
                                        ...
                                        if pressed_now && !was_held {
                                            ...
                                            actions.commands.push(EngineCommand::TriggerAdsr {
                                                uuid: sid.clone(),
                                            });
                                        } else if !pressed_now && was_held {
                                            ui.memory_mut(|m| m.data.insert_temp(gate_id, false));
                                            actions.commands.push(EngineCommand::ReleaseAdsr {
                                                uuid: sid.clone(),
                                            });
                                        }
                                    }
                                ...
                                ModSourceUI::StepSequencer {
                                    ...
                                    render_step_sequencer_controls(
                                        ui,
                                        idx,
                                        sid,
                                        steps,
...
fn render_step_sequencer_controls(
    ...
    ui.horizontal(|ui| {
        ...
        if render_mod_learn_slider(
            ...
            actions.commands.push(EngineCommand::UpdateStepSeqRate {
                uuid: sid.to_string(),
                rate: r,
            });
        }
    ...
    ui.horizontal(|ui| {
            ...
            .show_ui(ui, |ui| {
                for (i, name) in interp_names.iter().enumerate() {
                        ...
                        .changed()
                    {
                        ...
                        actions
                            .commands
                            .push(EngineCommand::UpdateStepSeqInterpolation {
                                uuid: sid.to_string(),
        ...
        if ui
            ...
            .changed()
        {
            actions.commands.push(EngineCommand::UpdateStepSeqBipolar {
                uuid: sid.to_string(),
                bipolar: bp,
            });
        }
        ...
        .show_ui(ui, |ui| {
            ...
            if has_assignment {
                ...
                if ui
                    ...
                    .clicked()
                {
                    actions.commands.push(EngineCommand::RemoveModOnMod {
                        target_source_id: target_uuid.to_string(),
                        param_name: param_name.to_string(),
                    });
                }
