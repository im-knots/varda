...
pub type CommandEnvelope = (EngineCommand, Option<tokio::sync::oneshot::Sender<CommandResult>>);
...
pub enum EngineCommand {
    ...
    // ── Video Playback ────────────────────────────────────────────
    VideoTogglePlay { channel_idx: usize, deck_idx: usize },
    VideoSeek { channel_idx: usize, deck_idx: usize, position_secs: f64 },
    VideoSetSpeed { channel_idx: usize, deck_idx: usize, speed: f64 },
    VideoSetLoopMode { channel_idx: usize, deck_idx: usize, mode: crate::video::LoopMode },
    VideoSetInPoint { channel_idx: usize, deck_idx: usize, secs: f64 },
    VideoSetOutPoint { channel_idx: usize, deck_idx: usize, secs: f64 },
    VideoClearInOutPoints { channel_idx: usize, deck_idx: usize },

    // ── Deck Auto-Transitions ──────────────────────────────────
    SetAutoTransitionEnabled { channel_idx: usize, deck_idx: usize, enabled: bool },
    SetAutoTransitionTrigger { channel_idx: usize, deck_idx: usize, clip_end: bool },
    SetAutoTransitionPlayDuration { channel_idx: usize, deck_idx: usize, value: f64, unit: crate::channel::DurationUnit },
    SetAutoTransitionDuration { channel_idx: usize, deck_idx: usize, value: f64, unit: crate::channel::DurationUnit },
    SetAutoTransitionShader { channel_idx: usize, deck_idx: usize, shader_name: Option<String> },
    ToggleAutoTransitionPlayDurationUnit { channel_idx: usize, deck_idx: usize },
    ToggleAutoTransitionDurationUnit { channel_idx: usize, deck_idx: usize },
    SetAutoTransitionPlayDurationValue { channel_idx: usize, deck_idx: usize, value: f64 },
    SetAutoTransitionDurationValue { channel_idx: usize, deck_idx: usize, value: f64 },
    ...
    PlaySequence { idx: usize },
    StopSequence { idx: usize },
    ToggleSequence { idx: usize },
    AddFadeStep { seq_idx: usize, from_ch: usize, to_ch: usize },
    AddWaitStep { seq_idx: usize },
    AddGoToStep { seq_idx: usize, step_index: usize },
    RemoveStep { seq_idx: usize, step_idx: usize },
    SetStepDuration { seq_idx: usize, step_idx: usize, value: f64, unit: crate::channel::DurationUnit },
    SetStepEasing { seq_idx: usize, step_idx: usize, easing: String },
    SetStepTransitionShader { seq_idx: usize, step_idx: usize, shader_name: Option<String> },
    ...
    // ── Output ─────────────────────────────────────────────────
    CreateOutput,
    CreateHeadlessOutput { target: crate::renderer::context::OutputTarget },
    CloseOutput { idx: usize },
    SetOutputDisplay { idx: usize, monitor_name: String },
    SetOutputTarget { idx: usize, target: crate::renderer::context::OutputTarget },
    StartOutput { idx: usize },
    StopOutput { idx: usize },
    ...
    UpdateSurfaceVertices { uuid: String, vertices: Vec<[f32; 2]> },
    DuplicateSurface { uuid: String },
    FlipSurfaceHorizontal { uuid: String },
    FlipSurfaceVertical { uuid: String },
    InsertSurfaceVertex { uuid: String, after_vert_idx: usize, position: [f32; 2] },
    SetCircleRadius { uuid: String, radius: f32 },
    SetCircleSides { uuid: String, sides: u32 },
    ConvertSurfaceToPolygon { uuid: String },
    CombineSurfaces { uuids: Vec<String> },
    MoveSurface { uuid: String, dx: f32, dy: f32 },
    UpdateSurfaceContourVertices { uuid: String, contour: usize, vertices: Vec<[f32; 2]> },
    ...
    UpdateLfoPhase { uuid: String, phase: f32 },
    UpdateLfoAmplitude { uuid: String, amplitude: f32 },
    UpdateLfoBipolar { uuid: String, bipolar: bool },
    UpdateAudioSmoothing { uuid: String, smoothing: f32 },
    UpdateAudioFreqRange { uuid: String, freq_low: f32, freq_high: f32 },
    UpdateAudioFreqLow { uuid: String, freq_low: f32 },
    UpdateAudioFreqHigh { uuid: String, freq_high: f32 },
    UpdateAudioGain { uuid: String, gain: f32 },
    UpdateAudioPreset { uuid: String, preset: AudioBandPreset },
    UpdateAudioMode { uuid: String, mode: crate::modulation::AudioReactMode },
    UpdateAudioSource { uuid: String, source_id: Option<AudioSourceId> },
    UpdateAudioNoiseGate { uuid: String, noise_gate: f32 },
    UpdateAdsrAttack { uuid: String, attack: f32 },
    UpdateAdsrDecay { uuid: String, decay: f32 },
    UpdateAdsrSustain { uuid: String, sustain: f32 },
    UpdateAdsrRelease { uuid: String, release: f32 },
    TriggerAdsr { uuid: String },
    ReleaseAdsr { uuid: String },
    UpdateStepSeqSteps { uuid: String, steps: Vec<f32> },
    UpdateStepSeqRate { uuid: String, rate: f32 },
    UpdateStepSeqInterpolation { uuid: String, interpolation: crate::modulation::StepInterpolation },
    UpdateStepSeqBipolar { uuid: String, bipolar: bool },
    SetStepSeqCount { uuid: String, count: usize },
    UpdateStepSeqValue { uuid: String, step_idx: usize, value: f32 },
    ...
    RescanMidi,
    RescanAudio,
    ToggleAudioSource { source_id: u32, enabled: bool },
    SetMidiDeviceEnabled { device_id: crate::midi::DeviceId, enabled: bool },

    // ── MIDI Mappings ──────────────────────────────────────────
    ClearMidiMappings,
    RemoveMidiMapping { key: crate::midi::MidiKey },

    // ── Clock ──────────────────────────────────────────────────
    SetClockPreference { preference: crate::clock::ClockPreference },
    SetManualBpm { bpm: f32 },

    // ── Parameters (index-based) ─────────────────────────────────
    SetGeneratorParam { channel_idx: usize, deck_idx: usize, name: String, value: ParamValue },
    SetEffectParam { channel_idx: usize, deck_idx: usize, effect_idx: usize, name: String, value: ParamValue },
    SetChannelEffectParam { channel_idx: usize, effect_idx: usize, name: String, value: ParamValue },
    SetMasterEffectParam { effect_idx: usize, name: String, value: ParamValue },
    ResetGeneratorParamsToDefaults { channel_idx: usize, deck_idx: usize },

    // ── Resolution ─────────────────────────────────────────────
    SetRenderResolution { width: u32, height: u32 },
