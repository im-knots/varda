            ...
            let cmd = match action {
                ...
                ModulationAction::RemoveSource { source_id } => {
                    EngineCommand::RemoveModulationSource {
                        uuid: source_id.clone(),
                    }
                }
                ModulationAction::UpdateLFOFrequency {
                    source_id,
                    frequency,
                ...
                ModulationAction::UpdateLFOWaveform {
                    source_id,
                    waveform,
                ...
                ModulationAction::UpdateLFOPhase { source_id, phase } => {
                    EngineCommand::UpdateLfoPhase {
                        uuid: source_id.clone(),
                        phase: *phase,
                    }
                }
                ModulationAction::UpdateLFOAmplitude {
                    source_id,
                    amplitude,
                ...
                ModulationAction::UpdateLFOBipolar { source_id, bipolar } => {
                    EngineCommand::UpdateLfoBipolar {
                        uuid: source_id.clone(),
                        bipolar: *bipolar,
                    }
                }
                ModulationAction::UpdateAudioSmoothing {
                    source_id,
                    smoothing,
                ...
                ModulationAction::UpdateAudioFreqLow {
                    source_id,
                    freq_low,
                ...
                ModulationAction::UpdateAudioFreqHigh {
                    source_id,
                    freq_high,
                ...
                ModulationAction::UpdateAudioSource {
                    source_id,
                    source_id_audio,
                ...
                ModulationAction::UpdateAudioNoiseGate {
                    source_id,
                    noise_gate,
                ...
                ModulationAction::TriggerADSR { source_id } => EngineCommand::TriggerAdsr {
                    uuid: source_id.clone(),
                },
                ModulationAction::ReleaseADSR { source_id } => EngineCommand::ReleaseAdsr {
                    uuid: source_id.clone(),
                },
                ModulationAction::UpdateStepValue {
                    source_id,
                    step_idx,
                    value,
                ...
                ModulationAction::UpdateStepRate { source_id, rate } => {
                    EngineCommand::UpdateStepSeqRate {
                        uuid: source_id.clone(),
                        rate: *rate,
                    }
                }
                ...
                ModulationAction::UpdateStepBipolar { source_id, bipolar } => {
                    EngineCommand::UpdateStepSeqBipolar {
                        uuid: source_id.clone(),
                        bipolar: *bipolar,
                    }
                }
                ModulationAction::SetStepCount { source_id, count } => {
                    EngineCommand::SetStepSeqCount {
                        uuid: source_id.clone(),
                        count: *count,
                    }
                }
                ModulationAction::AssignModOnMod {
                    target_source_id,
                    param_name,
                    modulator_id,
                    amount,
                    ...
                    modulator_id: modulator_id.clone(),
                    amount: *amount,
                },
                ModulationAction::RemoveModOnMod {
                    target_source_id,
                    param_name,
                ...
                ModulationAction::AssignModulation {
                    deck_uuid,
                    param_name,
                    source_id,
                    amount,
                } => EngineCommand::AssignModulation {
                    target: format!("deck_{}:{}", deck_uuid, param_name),
                    source_id: source_id.clone(),
                    amount: *amount,
                },
                ModulationAction::RemoveAssignment {
                    deck_uuid,
                    param_name,
                    ..
