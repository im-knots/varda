...
impl VardaApp {
    ...
    pub fn cmd_add_syphon_deck(&mut self, channel_idx: usize, server_name: String) -> CommandResult {
        #[cfg(target_os = "macos")]
        {
    ...
    pub fn cmd_add_srt_deck(&mut self, channel_idx: usize, url: String, mode: crate::stream::SrtMode) -> CommandResult {
    ...
    pub fn cmd_add_rtmp_deck(&mut self, channel_idx: usize, url: String, mode: crate::stream::RtmpMode) -> CommandResult {
    ...
    pub fn cmd_add_stream_library_entry(&mut self, url: String, mode: crate::stream::SrtMode) -> CommandResult {
    ...
    pub fn cmd_add_rtmp_library_entry(&mut self, url: String, mode: crate::stream::RtmpMode) -> CommandResult {
