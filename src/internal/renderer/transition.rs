...
impl TransitionPipeline {
    ...
    pub fn create_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: wgpu::BindingResource::TextureView(start_view),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: wgpu::BindingResource::TextureView(end_view),
                },
                wgpu::BindGroupEntry {
                    binding: 4,
    ...
    pub fn render_to_cmd(
        ...
        let bind_group =
            self.create_bind_group(&context.device, start_view, end_view, user_params_buffer);
